...
NAV=( "Home|index.html" "Spec|spec.html" "Proof|proof-profile.html" "Science|science-profile.html" \
      "Impact graph|impact-graph.html" "Identifiers|identifiers.html" "Examples|examples.html" "FAQ|faq.html" )
...
page(){ # $1 src md   $2 out html   $3 <title>
